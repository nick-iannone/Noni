<template>
    <div class="page">
        <h2 class="username">{{$store.state.user.username}}'s Collections</h2>
        <div class="collections_container">
            <collection-tile class="collection_tile" v-bind:collection="collection" v-bind:key="collection.collectionID" 
