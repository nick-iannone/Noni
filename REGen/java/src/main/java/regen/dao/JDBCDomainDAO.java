...
public class JDBCDomainDAO {
	
	private JdbcTemplate jdbcTemplate;
	
	public JDBCDomainDAO(DataSource dataSource) {
		this.jdbcTemplate = new JdbcTemplate(dataSource);
	}
	
	public void saveCharacter(PlayerCharacter newCharacter) {
		newCharacter.setCharID(getNextCharacterID());
		String sqlSaveCharacter = "INSERT INTO character (character_id, name, class_id, race_id, weapon_id, ac, hp, xp, saved_on) " +
							   	  "VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)";
		jdbcTemplate.update(sqlSaveCharacter, newCharacter.getCharID(), newCharacter.getName(), newCharacter.getCharClass().getClassID(), 
											  ...
											  newCharacter.getAC(), newCharacter.getHP(), newCharacter.getXP(), newCharacter.getSavedOn());
	}
	...
	public List<PlayerCharacter> getSavedCharacters() {
		...
		String sqlGetSavedCharacters = "SELECT * FROM character ORDER BY character_id";
		SqlRowSet results = jdbcTemplate.queryForRowSet(sqlGetSavedCharacters);
		while(results.next()) {
	...
	public PlayerCharacter mapRowToPlayerChar(SqlRowSet results) {
	...
	public Race mapRowToRace(SqlRowSet results) {
	...
	public CharacterClass mapRowToClass(SqlRowSet results) {
	...
	public Weapon mapRowToWeapon(SqlRowSet results) {
	...
	public Mob mapRowToMob(SqlRowSet results) {
	...
	public Setting mapRowToLocation (SqlRowSet results) {
	...
	public Spell mapRowToSpell(SqlRowSet results) {
